...
#elif ((PRINTF_UART_CONSOLE >= 1) && (PRINTF_UART_CONSOLE <= 2))
...
#if (PRINTF_UART_CONSOLE == LP) /* Instance B_RX & Instance B_TX */
...
#define PRINTF_UART_CONSOLE_TX_PADCTRL         0
#else
#error "Invalid PRINTF_UART_CONSOLE value: use 1 (UART1), 2 (UART2), or LP (LPUART)"
