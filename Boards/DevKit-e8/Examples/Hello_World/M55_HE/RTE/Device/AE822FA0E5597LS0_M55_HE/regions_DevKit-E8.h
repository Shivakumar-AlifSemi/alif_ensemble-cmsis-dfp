#ifndef REGIONS_DEVKIT_E8_H
#define REGIONS_DEVKIT_E8_H
...
// <i> Device Family Pack (DFP):   AlifSemiconductor::Ensemble@2.0.0
// <i> Board Support Pack (BSP):   AlifSemiconductor::Ensemble@2.0.0
